export default {
  ...
  setup: {
    ...
    apiPort: 'API Port',
    portHint: 'Ports are set by the startup flags (-web_port / -api_port) or config.ini; changing them requires a restart',
  ...
  settings: {
    ...
    restartPortChanged: 'System restarted with new ports — management {manage}, API {api}. Please use the new addresses.',
    portLockedByDocker: 'Docker instance: the ports come from the run command (-web_port / -api_port) or the environment — change them in the container arguments',
