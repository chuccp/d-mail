export default {
  ...
  setup: {
    ...
    webPort: '管理端口',
    apiPort: 'API 端口',
    portHint: '端口由启动参数（-web_port / -api_port）或 config.ini 指定，修改后需重启服务',
    adminAccount: '管理员账号',
  ...
  settings: {
    ...
    restartPortChanged: '系统已重启，端口已变更：管理端口 {manage}、API 端口 {api}，请使用新地址访问',
    portLockedByDocker: 'Docker 环境：端口由启动命令（-web_port / -api_port）或环境变量指定，需在容器运行参数中修改',
    restarting: '重启中...',
